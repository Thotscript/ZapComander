...
- Data (mantenha exatamente como o usuário falou: ex: "hoje", "amanhã", "amanha", "quarta-feira", "12 de junho")
...
- Se o usuário disser "hoje", "amanhã", "amanha", "AMANHA", "Amanhã", "AMANHÃ" ou nomes de dias, **retorne essas palavras exatamente como foram ditas** no campo `"data"`.
